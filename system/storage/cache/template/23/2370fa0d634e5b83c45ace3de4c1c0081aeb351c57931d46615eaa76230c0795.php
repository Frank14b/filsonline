...
class __TwigTemplate_acfff150455f500e9a1f0f0b4dda560dd8736284380baf1b17bd4d6c79052587 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .module-products-359 .product-grid .product-thumb {
    margin: 5px;
    border-radius: 15px;
    box-shadow: rgba(50, 50, 93, 0.55) 0px 13px 7px 5px; 
  }
</style>
