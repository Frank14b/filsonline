...
class __TwigTemplate_9cb220ba48d3677c32114e5124c3aaf5b072eb7e13d5f08ed09d479b6988d6b2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text(((minuteLeft/hourLeft) < 10) ? '0'+(minuteLeft/hourLeft): (minuteLeft/hourLeft))
}
})</script></body></html>
";
    }
