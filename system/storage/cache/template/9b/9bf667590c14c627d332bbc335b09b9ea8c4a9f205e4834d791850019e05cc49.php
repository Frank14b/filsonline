...
class __TwigTemplate_0cfdf9328d6389ddb17a2a382b97030ab9ed99b5742cf6bc2a511b85d76b3ef2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
.links-menu-72 .module-body li a {
  ...
  font-size: 12px;
  padding: 10px 1em 5px 1px;
}
</style>

<script>
  \$(document).ready(function() {
    \$('.links-menu-72').find(\".links-menu-item\", function() {
