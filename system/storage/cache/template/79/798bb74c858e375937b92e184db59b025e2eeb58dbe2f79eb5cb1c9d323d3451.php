...
class __TwigTemplate_0cd48e48113b1ef805d93e1896277b79c0dd6fed59d216d657fc889e895042b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 1), "get", [0 => "catalogCurrencyStatus"], "method", false, false, false, 1)) {
            ...
            if ((twig_length_filter($this->env, ($context["currencies"] ?? null)) > 1)) {
                ...
                // line 9
                echo "  <div class=\"t-10 text-primo\" style=\"margin-bottom:-20px; margin-top: -10px; color:rgba(140, 187, 13, 0.993)\"><b>urrency</b></div>
    ...
    <form action=\"";
      ...
      <div class=\"dropdown drop-menu\">
        <button type=\"button\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">
          <span class=\"currency-symbol-title\" style=\"color:rgba(140, 187, 13, 0.993)\">
            ";
                // line 15
