...
class __TwigTemplate_8eb7b3e59d8ab8d6081cb91a7a70600e1898dd1d5dee524ac92ee624c8e47334 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .module-grid-366 .grid-row-1 .grid-col-1 {
    position: absolute;
    left: -5%;
    right: -5%;
    height: 300px;
...
";
        // line 165
        echo twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "loadController", [0 => "journal3/layout", 1 => "top"], "method", false, false, false, 165);
        echo "
";
        // line 166
...
";
        ...
        // line 182
        echo twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "loadController", [0 => "journal3/seo/rich_snippets"], "method", false, false, false, 182);
        echo "
";
        // line 183
...
";
    ...
    {
        return array (  260 => 183,  256 => 182,  249 => 179,  240 => 177,  237 => 176,  234 => 175,  231 => 174,  228 => 173,  225 => 172,  222 => 171,  219 => 170,  217 => 169,  213 => 168,  210 => 167,  208 => 166,  204 => 165,  37 => 1,);
    }
