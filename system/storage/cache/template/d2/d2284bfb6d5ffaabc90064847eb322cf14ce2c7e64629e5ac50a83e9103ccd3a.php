...
class __TwigTemplate_3b2161f2631e3b8f08e404471559fbbf80f056c74995b2117ffbde12a0bbc92f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tax_class"]) {
            // line 40
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 40) == ($context["shipping_item_tax_class_id"] ?? null))) {
                // line 41
                echo "                <option value=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            // line 55
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 55) == ($context["shipping_item_geo_zone_id"] ?? null))) {
                // line 56
                echo "                <option value=\"";
...
";
    ...
    {
        return new Source("", "extension/shipping/item.twig", "");
    }
}
