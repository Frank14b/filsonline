...
class __TwigTemplate_8c02f4ebc8e787fd45fe6e690b8f0cd70ff88753cafe94237e826778a2ec0967 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .module-products-359 .product-grid .product-thumb {
    margin: 5px;
    border-radius: 15px;
    box-shadow: rgba(50, 50, 93, 0.55) 0px 3px 7px 5px; 
  }
</style>
