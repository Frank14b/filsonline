...
class __TwigTemplate_5d5a8a54492545867c905baf7e165373a047a53fff513669f18e110038a8b616 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
  \$(document).ready(function() {
    ...
    \$(\".category-thumb, .manufacturer-thumb\").css({'border':'0px'})
  })
</script>
