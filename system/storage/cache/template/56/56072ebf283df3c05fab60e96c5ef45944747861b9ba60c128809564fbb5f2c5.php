...
class __TwigTemplate_0aa260fff255a19a7a25da87886fdcf67bdebb54072cdefd9c5a703e7188957a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text((Math.ceil(minuteLeft/(hourLeft)) < 10) ? '0'+Math.ceil(minuteLeft/(hourLeft)): Math.ceil(minuteLeft/(hourLeft)))
}
})</script></body></html>
";
    }
