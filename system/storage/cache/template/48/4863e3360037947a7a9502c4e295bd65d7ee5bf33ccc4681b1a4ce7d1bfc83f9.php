...
class __TwigTemplate_ae57b9a21e82c9b2bce912697d11ab1469236af04af7054806afc97d264eeaf1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
  \$(document).ready(function() {
    ...
    if(counterend) {
      ...
      let hours = counterend.split(\"/\")[4]
      let minutes = counterend.split(\"/\")[5]
      let seconds = counterend.split(\"/\")[6]
      alert(new Date(\"22/03/2022 08:00 PM\"))
    }
  })
</script>
