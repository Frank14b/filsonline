...
class __TwigTemplate_f4fdb3aada00629f69a1bd40ccca2d20a2168e68c58d2fa93153bb87c9b783e3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text((Math.ceil(minuteLeft/(hourLeft+1)) < 10) ? '0'+Math.ceil(minuteLeft/(hourLeft+1)): Math.ceil(minuteLeft/(hourLeft+1)))
}
})</script></body></html>
";
    }
