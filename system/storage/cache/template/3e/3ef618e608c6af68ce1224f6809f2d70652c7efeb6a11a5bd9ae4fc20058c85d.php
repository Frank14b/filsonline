...
class __TwigTemplate_9f375aaea03d15b560a39daa43fdf35419d640b9e5f33d8ef3e32dd36e60eb29 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text(((Math.ceil(minuteLeft/(hourLeft)) - today.getMinutes()) < 10) ? '0'+(Math.ceil(minuteLeft/(hourLeft) - today.getMinutes())): (Math.ceil(minuteLeft/(hourLeft)) - today.getMinutes()))
}
})</script></body></html>
";
    }
