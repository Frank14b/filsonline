...
class __TwigTemplate_858289c38df9c2f066a53ea3767818cb382f3cf4bdb7163e954d37b9c5e2adca extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text((Math.ceil((minuteLeft-1)/(hourLeft+1)) < 10) ? '0'+Math.ceil((minuteLeft-1)/(hourLeft+1)): Math.ceil((minuteLeft-1)/(hourLeft+1)))
}
})</script></body></html>
";
    }
