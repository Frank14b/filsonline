...
class __TwigTemplate_bb4e8274a64d0db8ca4f11b0054ef8b2519156cb365d6fd684bdf44627022eac extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 1), "get", [0 => "catalogLanguageStatus"], "method", false, false, false, 1)) {
            ...
            if ((twig_length_filter($this->env, ($context["languages"] ?? null)) > 1)) {
                ...
                // line 9
                echo "  <div class=\"t-10 text-primo\" style=\"margin-bottom:-20px; margin-top: -10px; color:rgba(140, 187, 13, 0.993)\">Language</div>
