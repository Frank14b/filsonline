...
class __TwigTemplate_f01685278caf920fd489e40b65a29a5b809e0625bed10a2bc43040055521f2ce extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter2\").text(((hourLeft-1 ) < 10) ? '0'+(hourLeft-1): (hourLeft-1))
  \$(\"#day-counter3\").text(((Math.ceil(minuteLeft/(hourLeft+1)) - today.getMinutes()) < 10) ? '0'+(Math.ceil(minuteLeft/(hourLeft+1) - today.getMinutes())): (Math.ceil(minuteLeft/(hourLeft+1)) - today.getMinutes()))
}
})</script></body></html>
";
    }
