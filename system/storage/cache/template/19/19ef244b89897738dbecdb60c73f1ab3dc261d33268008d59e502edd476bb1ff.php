...
class __TwigTemplate_f1bf66e315a7ea70e15334454ce73727debe560b509e9f56bf0bacea3b644849 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text(((minuteLeft/(hourLeft-1)) < 10) ? '0'+(minuteLeft/(hourLeft - 1)): (minuteLeft/(hourLeft -1)))
}
})</script></body></html>
";
    }
