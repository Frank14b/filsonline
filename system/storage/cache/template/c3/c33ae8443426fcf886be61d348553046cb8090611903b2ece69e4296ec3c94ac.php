...
class __TwigTemplate_fa809f02411d562364cbfae9014855a398200775220c9293b645ef5203abeeb6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .module-products-359 .product-grid .product-thumb {
    margin: 5px;
    border-radius: 15px;
    box-shadow: rgba(50, 50, 93, 0.55) 0px 13px 7px 5px, rgba(0, 0, 0, 0.5) 0px 8px 3px -8px; 
  }
</style>
