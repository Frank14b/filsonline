...
class __TwigTemplate_b02d3f19c8d7a4e4f5dbed38f6181babd34a032c209cc8c9383a1aeaa17d177b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .ms-view {
    border-radius: 3em;
    box-shadow: rgba(50, 50, 93, 0.55) 0px 13px 27px 0px, rgba(0, 0, 0, 0.5) 0px 8px 16px 2px; 
  }
  .ms-time-bar {
    display: none;
  }
