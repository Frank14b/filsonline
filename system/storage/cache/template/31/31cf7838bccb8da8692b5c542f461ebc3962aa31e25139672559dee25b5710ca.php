...
class __TwigTemplate_81c29ae2967d42ab80fd4ff1e5a8b5b7929b8c1a2e4877df27d6766bc08b7b44 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .ms-view {
    border-radius: 3em;
    box-shadow: rgba(50, 50, 93, 0.55) 0px 13px 27px 2px, rgba(0, 0, 0, 0.5) 0px 8px 16px 2px; 
  }
  .ms-time-bar {
    display: none;
  }
