...
class __TwigTemplate_b0f068cf964e25c24d88d9da1ba3ce725cd331d2f64ee3af61f120990b1e301e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text(((60 today.getMinutes()) < 10) ? '0'+(Math.ceil(60 - today.getMinutes())): (60 - today.getMinutes()))
}
})</script></body></html>
";
    }
