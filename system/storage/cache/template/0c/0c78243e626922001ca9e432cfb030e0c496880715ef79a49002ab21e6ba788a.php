...
class __TwigTemplate_fa5d6c35a2f0a5f654a10ab513fc1fcaa93bd86936e613ce9d415f573088da83 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
if (counterend) {
  ...
  \$(\"#day-counter3\").text(((Math.ceil(minuteLeft/(hourLeft+1)) - 8) < 10) ? '0'+(Math.ceil(minuteLeft/(hourLeft+1) - 8)): (Math.ceil(minuteLeft/(hourLeft+1)) - 8))
}
})</script></body></html>
";
    }
