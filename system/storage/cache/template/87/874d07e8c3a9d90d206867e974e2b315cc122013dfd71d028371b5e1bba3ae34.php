...
class __TwigTemplate_97e74e12150754268238bfa659292c6b85d2b1f58bbefecd0469637512162e16 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t}
  ...
  .ms-view {
    border-radius: 3em;
    box-shadow: rgba(50, 50, 93, 0.55) 4px 13px 27px -5px, rgba(0, 0, 0, 0.5) 0px 8px 16px -8px; 
  }
  .ms-time-bar {
    display: none;
  }
